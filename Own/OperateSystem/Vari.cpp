...
RoboArm roboArm(&canPlus1,
                ...
                4, 65536, 10,
                1,
                1, Pid(25 * 1.1, 0.05 , 13, 10, 2000), Pid(2.f, 0.01f, 1.f, 2000.f, 10000.0f),
                2, Pid(25 * 1.1, 0.05 , 13 , 10, 2000), Pid(2.f, 0.01f, 1.f, 2000.f, 10000.0f),
                &hi2c1,
                {360 - 66.7289963, -45.0833359 + 360 - 102.278336, -45.0833359 + 37.5383339, 135 + 27.9533329, 125.261002, 0, 0});
