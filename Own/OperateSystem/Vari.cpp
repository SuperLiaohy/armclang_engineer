...
RoboArm roboArm(&canPlus1,
                ...
                4, 65536, 10,
                1,
                1, Pid(900, 0.05 , 100, 5000, 10000, 0.5), Pid(1.5f, 0.05f, 0.5f, 8000.f, 10000.0f),
                2, Pid(900, 0.05 , 100 , 5000, 10000, 0.5), Pid(1.5f, 0.05f, 0.5f, 8000.f, 10000.0f),
                &hi2c1,
                {126.396004, -45.0833359 + 360 - 102.278336, -45.0833359 + 37.5383339, 135 + 27.9533329, 125.261002, 0, 0});
