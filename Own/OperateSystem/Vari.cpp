...
RoboArm roboArm(&canPlus1,
                ...
                4, 65536, 10,
                0.7,
                1, Pid(60 * 4, 0.05, 5, 1600, 8000), Pid(2.f, 0.01f, 0.2f, 2000.f, 10000.0f),
                2, Pid(60 * 4, 0.05, 5, 1600, 8000), Pid(2.f, 0.01f, 0.2f, 2000.f, 10000.0f),
                {79, 360 - 87.445007, 53.24833322, 135 + 27.256, 280, -90, 90});
